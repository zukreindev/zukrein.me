...
<main class="container">
	<div id="github" class="pt-10">
		{#if why}
			<h2 class=" mt-32 text-white text-4xl font-semibold mb-3 pb-3">GitHub Profile</h2>
	
			<div class="px-4 py-4 bg-[#0d1117af] rounded-lg shadow-lg">
				<div class="flex">
					...
					<div>
						...
						<div>
							...
							<div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-7 lg:space-x-2">
								{#if wyh}
									{#each githubrepo as repo}
										<a href={repo.html_url} target="_blank" rel="noopener noreferrer">
											<div class=" w-48 bg-gray-800 hover:bg-gray-700 transition-all rounded-md mx-3 my-2 p-1 pl-3">
